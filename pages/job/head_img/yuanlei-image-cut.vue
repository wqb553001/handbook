	...
	<view class="uni-content-info">
		...
		<view class='cropper-operate'>
			...
			<view class="cropper-operate-button cropper-operate-button-reset" @click="rotateRightValue(0)">
				<uni-icons type="top" size="20"></uni-icons>不旋转
			</view>
  ...
  // 获取手机信息
	...
	export default {
		...
		methods: {
			...
			// scaleChange(e) {
			// 	console.log('滑动选项 发生变化：' + e.detail.value)
			// 	const newScale = parseFloat(e.detail.value.toFixed(1)); // 保留1位小数
				
			// 	let scaleVal = 150 * newScale;
			// 	this.setData({
			// 		cutL: scaleVal,
			// 		cutT: scaleVal,
			// 		cutR: scaleVal,
			...
			// 	})
			// 	this.getImageInfo()
			// 	// this.scaleTate = scaleVal
			// 	this.changeScale(newScale)
			// 	console.log('当前缩放比例:', this.scaleTate);
			// },
			rotateRightNum(e){
